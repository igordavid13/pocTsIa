import { Preprocessor } from 'parse5/dist/tokenizer/preprocessor';
import { type Token, type CharacterToken, type DoctypeToken, type TagToken, type EOFToken, type CommentToken, type Attribute, type Location } from 'parse5/dist/common/token';
import { EntityDecoder } from 'entities/lib/decode';
